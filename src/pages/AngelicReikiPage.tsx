...
import angelicReikiBg from "@/assets/angelic-reiki-bg.jpg";

const AngelicReikiPage = () => {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src={angelicReikiBg} 
            alt="Angelic Reiki divine wings"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-slate-700/60 via-slate-600/40 to-slate-800/80" />
        </div>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex-1 flex flex-col justify-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 text-white leading-tight tracking-wide">
            {t('reiki.techniques.angelicReiki.title')}
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            {t('reiki.techniques.angelicReiki.description')}
          </p>
...
export default AngelicReikiPage;