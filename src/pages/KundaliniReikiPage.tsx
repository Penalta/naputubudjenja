...
import kundaliniReikiBg from "@/assets/kundalini-reiki-bg.jpg";

const KundaliniReikiPage = () => {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src={kundaliniReikiBg} 
            alt="Kundalini Reiki cosmic energy"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-orange-900/60 via-orange-800/40 to-orange-900/80" />
        </div>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex-1 flex flex-col justify-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 text-white leading-tight tracking-wide">
            {t('reiki.techniques.kundaliniReiki.title')}
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            {t('reiki.techniques.kundaliniReiki.description')}
          </p>
            ...
            <div className="relative" style={{
              ...
              <div className="relative mx-8 md:mx-16 py-12">
                ...
                <div className="px-6 md:px-12">
                  <div className="whitespace-pre-line text-amber-900 leading-relaxed text-base md:text-lg font-medium tracking-wide max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-amber-400/40 scrollbar-track-transparent" style={{
                    textShadow: '0 1px 2px rgba(139, 69, 19, 0.1)',
                    lineHeight: '1.8'
                  }}>
                    {t('kundaliniReiki.content')}
                  </div>
                </div>
...
export default KundaliniReikiPage;